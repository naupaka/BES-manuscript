...
back out. Intervals where calculated fluxes were \textless{} 0 (n = 12)
were excluded from the plot; 3 each from WREF and WOOD when using
(\(F_{011}\) approach).}
...
= 2 from the field estimated values at KONZ and n = 9 from field
