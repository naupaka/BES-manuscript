...
package}
\author{Ed Ayres\textsuperscript{1} \and Ridwan
Abdi\textsuperscript{3} \and Natalie
...
Lee\textsuperscript{3} \and Dijonë
Mehmeti\textsuperscript{3} \and Christina
Tran\textsuperscript{4} \and Ly Xiong\textsuperscript{3} \and Zoey
Werbin\textsuperscript{2} \and Naupaka
Zimmerman\textsuperscript{4} \and John Zobitz\textsuperscript{3}}
\date{}

\begin{document}
\maketitle

\textsuperscript{1} National Ecological Observatory Network, 1685 38th
Street, Suite 100, Boulder, CO 80301\\
\textsuperscript{2} Boston University, 5 Cummington Street, Boston, MA
02215\\
\textsuperscript{3} Augsburg University, 2211 Riverside Avenue,
...
J.Z acknowledges Kathleen O'Rourke for code development.. Technical
staff at USF. NEON field staff and assignable assets teams. LI-COR
technical staff for helpful discussions. NSF DEB grant \#2017829 awarded
to J.Z., and NSF DEB grant \#2017860 awarded to N. Z.
...
\captionsetup{labelsep=none}\includegraphics{figures/r2-plot.png}
...
\captionsetup{labelsep=none}\includegraphics{figures/diffusivity-plot.png}
