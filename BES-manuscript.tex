...
We used LI-COR SoilFluxPro software (v 5.3.1) to assess the
appropriateness of dead band and measurement duration using built-in
evaluation tools. The deadband was set for 30-40 seconds, depending on
the site, and the measurement duration was 180 seconds with a 30 second
pre-purge and a 30 second post-purge.
