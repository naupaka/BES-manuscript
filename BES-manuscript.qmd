...
-   $F_{101}$ is a surface flux estimate using fluxes estimated at the shallowest and deepest measurement layers ($F_{110}$, $F_{011}$). These computed fluxes then form the basis of additional linear extrapolation to the surface. For example, @hiranoLongtermHalfhourlyMeasurement2003 and @tangContinuousMeasurementsSoil2005 used an approach similar to $F_{101}$ in a temperate deciduous broadleaf forest and ponderosa pine forest respectively.
