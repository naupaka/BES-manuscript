...
We calculated the statistical 1-1 comparison between the various estimates of soil flux computed by `neonSoilFlux` with the field-measured fluxes within half-hourly periods. Statistics for these comparisons are reported in @tbl-flux-11-compare.
