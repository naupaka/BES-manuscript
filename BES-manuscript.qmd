...
Anonymous field-collected data, `neonSoilFlux` calculated outputs, and manuscript-generating code for peer review are provided as supplemental files. An anonymous link for peer-review is here: [https://doi.org/10.5281/zenodo.16951117](https://doi.org/10.5281/zenodo.16951117). This will be made publicly available upon publication.
