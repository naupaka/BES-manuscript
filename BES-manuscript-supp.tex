...
unity (indicated with a dashed line in
Figure~\ref{fig-uncertainty-stats} indicate lower reported uncertainty,
as propagated by quadrature due to a relatively higher precision of
measured input variables (CO\(_{2}\), \(T_{S}\), \(SWC\), or \(P\)).
