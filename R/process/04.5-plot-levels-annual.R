...
marshall_fluxes_small <- model_fluxes_marshall |>
  semi_join(field_data_joined,
            by = c("site",
                   "horizontalPosition" = "sampling_location"))
...
ggsave('figures/flux-results-year.png',
       plot = out_big, width = 7, height = 6)

### Now let's get these all plotted!
png('figures/flux-results-year.png',
