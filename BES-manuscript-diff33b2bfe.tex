...
%DIF DEL BES-manuscript-oldtmp-84385.tex   Sun Nov 16 10:27:12 2025
%DIF ADD BES-manuscript.tex                Sun Nov 16 10:17:41 2025
%DIF 2a2
...
Ashburner-Wright\textsuperscript{\DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{5}\DIFaddend } \and Lillian
Brown\textsuperscript{\DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{5}\DIFaddend } \and Ryan
Frink-Sobierajski\textsuperscript{\DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{5}\DIFaddend } \and Lajntxiag
Lee\textsuperscript{1} \and Dijonë
Mehmeti\textsuperscript{1} \and Christina
Tran\textsuperscript{\DIFdelbegin \DIFdel{4}\DIFdelend \DIFaddbegin \DIFadd{5}\DIFaddend } \and Ly Xiong\textsuperscript{1} \and Naupaka
...
02215\\
\textsuperscript{4} University of \DIFaddbegin \DIFadd{Kansas, 1450 Jayhawk Boulevard,
Lawrence, KS 66045}\\
\DIFadd{\textsuperscript{5} University of }\DIFaddend San Francisco, 2130 Fulton Street, San
Francisco, CA 94117
\DIFdelbegin %DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{\textsuperscript{5} University of Kansas, 1450 Jayhawk Boulevard,
Lawrence, KS 66045
}\DIFdelend 
...
\DIFdelbegin \DIFdel{JZ }\DIFdelend \DIFaddbegin \DIFadd{John Zobitz }\DIFaddend acknowledges Kathleen O'Rourke for code development. \DIFdelbegin \DIFdel{NZ }\DIFdelend \DIFaddbegin \DIFadd{Naupaka
Zimmerman }\DIFaddend thanks technical staff at USF for support with field gear
...
\#2017829 awarded to \DIFdelbegin \DIFdel{JZ}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz}\DIFaddend , and NSF DEB grant \#2017860 awarded to
\DIFdelbegin \DIFdel{NZ}\DIFdelend \DIFaddbegin \DIFadd{Naupaka Zimmerman}\DIFaddend . This material is based in part upon work supported by
...
Conceptualization: \DIFdelbegin \DIFdel{JZ, NZ}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman}\DIFaddend ; Methodology: \DIFdelbegin \DIFdel{EA, JZ, NZ}\DIFdelend \DIFaddbegin \DIFadd{Edward
Ayres, John Zobitz, Naupaka Zimmerman}\DIFaddend ; Software: \DIFdelbegin \DIFdel{JZ, NZ, ZW, E A, DM, RA, LX, LL}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka
Zimmerman, Zoey Werbin, Edward Ayres, Dijonë Mehmeti, Ridwan Abdi, Ly
Xiong, Lajntxiag Lee}\DIFaddend ; Validation: \DIFdelbegin \DIFdel{JZ, NZ}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman}\DIFaddend ; Formal
Analysis: \DIFdelbegin \DIFdel{JZ, NZ, DM, RA,
LX, LL}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman, Dijonë Mehmeti, Ridwan Abdi,
Ly Xiong, Lajntxiag Lee}\DIFaddend ; Investigation: \DIFdelbegin \DIFdel{JZ, NZ,
RF-S, CT, NA-W,
LB}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman,
Ryan Frink-Sobierajski, Christina Tran, Natalie Ashburner-Wright,
Lillian Brown}\DIFaddend ; Resources: \DIFdelbegin \DIFdel{JZ, NZ}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman}\DIFaddend ; Data curation:
\DIFdelbegin \DIFdel{JZ, NZ, DM, LX}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman, Dijonë Mehmeti, Ly Xiong}\DIFaddend ; Writing --
original draft: \DIFdelbegin \DIFdel{JZ, NZ}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman}\DIFaddend ; Writing -- review and
editing: \DIFdelbegin \DIFdel{JZ, NZ, ZW, EA,
CT, DM, LX,}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman, Zoey Werbin, Edward Ayres,
Christina Tran, Dijonë Mehmeti, Ly Xiong}\DIFaddend ; Visualization: \DIFdelbegin \DIFdel{JZ,
NZ, DM, RA, LX}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz,
Naupaka Zimmerman, Dijonë Mehmeti, Ridwan Abdi, Ly Xiong}\DIFaddend ; Supervision:
\DIFdelbegin \DIFdel{JZ; NZ; }\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman; }\DIFaddend Project Administration: \DIFdelbegin \DIFdel{JZ; NZ; }\DIFdelend \DIFaddbegin \DIFadd{John Zobitz,
Naupaka Zimmerman; }\DIFaddend Funding Acquisition: \DIFdelbegin \DIFdel{JZ; NZ
}\DIFdelend \DIFaddbegin \DIFadd{John Zobitz, Naupaka Zimmerman.
}\DIFaddend 

\section*{Data Availability}\label{data-availability}
\addcontentsline{toc}{section}{Data Availability}

\DIFdelbegin \DIFdel{Anonymous field-collected }\DIFdelend \DIFaddbegin \DIFadd{Data available via }\url{https://doi.org/10.5281/zenodo.17516319} \DIFadd{(Zobitz
\& Zimmerman, 2025). Field-collected }\DIFaddend data, \texttt{neonSoilFlux}
calculated outputs, and manuscript-generating code \DIFdelbegin \DIFdel{for peer review are provided as
supplemental files.
An anonymous link for peer-review is here:
}%DIFDELCMD < \url{https://doi.org/10.5281/zenodo.16951117}%%%
\DIFdel{. This will be made
publicly available upon publication.
}\DIFdelend \DIFaddbegin \DIFadd{are provided within
this repository.
}\DIFaddend 
...
\item
  \DIFaddend Accurate quantification of soil carbon fluxes is essential to reduce
  ...
  Hawai`i.
\DIFaddbegin \item
  \DIFaddend We present an R software package (\texttt{neonSoilFlux}) that acquires
...
\DIFaddbegin \item
  \DIFaddend Outputs from the \texttt{neonSoilFlux} showed agreement with measured
  fluxes (\(R^{2}\) between measured and \texttt{neonSoilFlux} outputs
  ranging from \DIFdelbegin \DIFdel{0.04 to 0.81 }\DIFdelend \DIFaddbegin \DIFadd{0.12 to 0.77 }\DIFaddend depending on calculation method used);
...
\DIFaddbegin \item
  \DIFaddend While the flux gradient method is broadly effective, its accuracy is
...
\DIFdelbegin \section{\DIFdel{Data for peer review}}%DIFAUXCMD
\addtocounter{section}{-1}%DIFAUXCMD
%DIFDELCMD < \label{data-for-peer-review}
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Anonymous field-collected data, }\texttt{\DIFdel{neonSoilFlux}} %DIFAUXCMD
\DIFdel{calculated
outputs, and manuscript-generating code for peer review are provided as
supplemental files. An anonymous link for peer-review is here:
}%DIFDELCMD < \url{https://doi.org/10.5281/zenodo.16951117}%%%
\DIFdel{. This will be made
publicly available upon publication.
}%DIFDELCMD < 
...
%DIFDELCMD < %%%
\DIFdelend \section{Introduction}\label{introduction}
...
using continuous sensor data across NEON sites \DIFaddbegin \DIFadd{using NEON data }\DIFaddend thus
...
\(F_{S}\) from \texttt{neonSoilFlux}. \DIFaddbegin \DIFadd{While open source R software tools
...
2024. \DIFaddbegin \DIFadd{Permits or waivers were sought and approved prior to field work at
...
concentration (\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024b), soil temperature (\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024d), soil water
content (\DIFdelbegin \DIFdel{National Ecological Observatory Network
(NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024e), barometric pressure from the nearby tower (\DIFdelbegin \DIFdel{National
Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend ,
2024a), and soil properties (e.g.~bulk density) (\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024c) from a
...
sensors have changed over time (\DIFdelbegin \DIFdel{National Ecological Observatory Network
(NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024e), raw sensor measurements
...
where \(T_{i}\) is soil temperature (\(^\circ\)C) at depth \(i\) (\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend ,
2024d) and \(P\) surface barometric pressure (kPa) (\DIFdelbegin \DIFdel{National Ecological Observatory
Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024a).
...
depth \(i\) (\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024e) and \(\phi\) is the porosity, which in turn is
a function of soil physical properties (\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024c):
...
cm\(^{-3}\)) excluding coarse fragments greater than 2 mm (\DIFdelbegin \DIFdel{National
Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024c),
...
analyzed (\DIFdelbegin \DIFdel{National
Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024c). We assume that rock fragments contain no
internal pores.
...
Ribbons for modeled soil fluxes represent \DIFaddbeginFL \DIFaddFL{approximately }\DIFaddendFL \(\pm\) 1
...
%DIFDELCMD < \includegraphics{figures/r2-plot.png}
%DIFDELCMD < 
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{figures/r2-plot.png}
...
level, ** = significance at the 1\% level. The \DIFaddbeginFL \DIFaddFL{slope (\(m\)) and
intercept (\(b\)) of the linear regression between measured and modeled
fluxes are also reported. The }\DIFaddendFL low-value outlier from KONZ in the
...
In \DIFdelbegin \DIFdel{four of }\DIFdelend \DIFaddbegin \DIFadd{one of the }\DIFaddend six field sites, the \emph{post hoc} \(D_{a}\) estimate
fell roughly between the two diffusion estimation methods\DIFdelbegin \DIFdel{; however this was less the case in the two }\DIFdelend \DIFaddbegin \DIFadd{. At UNDE,
WOOD, WREF, and SJER, the median field estimate of diffusivity was lower
than both of the other methods. At the }\DIFaddend driest sites, \DIFdelbegin \DIFdel{SJER and }\DIFdelend SRER
(Table~\ref{tbl-neon-sites}), \DIFdelbegin \DIFdel{where the }\DIFdelend \DIFaddbegin \DIFadd{the median }\DIFaddend field estimate of diffusivity
was \DIFdelbegin \DIFdel{either lower or }\DIFdelend higher than both of the other methods \DIFaddbegin \DIFadd{and values showed a large
amount of variation }\DIFaddend (Figure~\ref{fig-diffusivity-plot}).
...
the LICOR 6800 at all sites to standardize comparisons. \DIFaddbeginFL \DIFaddFL{Some outliers (n
...
comparative visualization across sites.}\DIFaddendFL }
...
estimated uncertainty of \(\pm5\%\) (\DIFdelbegin \DIFdel{National Ecological Observatory
Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend , 2024c). Coarse fragment
...
weather shifts. \DIFdelbegin \DIFdel{Four sites (KONZ, SRER, WREF, and UNDE) }\DIFdelend \DIFaddbegin \DIFadd{All sites }\DIFaddend had more than 75\% of half-hourly periods with
no-gap filled measurements (Figure S1, Supplementary Information). \DIFdelbegin \DIFdel{Two sites (SJER and WOOD) had more than 75\%
of half-hourly intervals with just one }\DIFdelend \DIFaddbegin \DIFadd{At
five out of six sites (all except SRER), we used at least some
}\DIFaddend gap-filled \DIFdelbegin \DIFdel{measurement. The large
...
sites (Figure S1). While we did not need to use gap-filled }\DIFdelend measurements \DIFdelbegin \DIFdel{to compute the flux at }\DIFdelend \DIFaddbegin \DIFadd{of Soil Water Content (SWC). At }\DIFaddend WREF, field data
collection occurred following a severe rainstorm, with soils at the
beginning of the sampling week near their water holding capacity\DIFaddbegin \DIFadd{, which
can influence the soil moisture sensor accuracy}\DIFaddend . In general, we
...
from \DIFdelbegin \DIFdel{0.04 to 0.81}\DIFdelend \DIFaddbegin \DIFadd{0.12 to 0.77}\DIFaddend ; Figure~\ref{fig-r2-plot}). One advantage of the
...
computation method (Section~\ref{sec-compute-soil-flux}). \DIFdelbegin \DIFdel{A sensitivity analysis }\DIFdelend \DIFaddbegin \DIFadd{We performed a
sensitivity analysis to compare the impact of these factors }\DIFaddend (Figure S2,
Supplemental Information)\DIFdelbegin \DIFdel{found that flux output
uncertainty was dominated by measurement uncertainty (\(T_{S}\), \(P\),
\(SWC\), or CO\(_{2}\)) rather than by the diffusivity method used to
compute soil flux.
Notably, the \(F_{110}\) method was least sensitive
...
algorithms (\DIFdelbegin \DIFdel{e.g.~}\DIFdelend \DIFaddbegin \emph{\DIFadd{e.g.}} \DIFaddend random forest) to generate a single flux
...
\DIFaddbegin \bibitem[\citeproctext]{ref-jurasinskiFluxFluxRate2022}
\DIFadd{Jurasinski, G., Koebsch, F., Guenther, A., \& Beetz, S. (2022).
}\emph{\DIFadd{Flux: }{\DIFadd{Flux Rate Calculation}} \DIFadd{from }{\DIFadd{Dynamic Closed Chamber
Measurements}}}\DIFadd{.
}

\DIFaddend \bibitem[\citeproctext]{ref-liuRobustGapfillingApproach2023}
...
\DIFdelbegin \DIFdel{NEON
(National Ecological Observatory Network). (}\DIFdelend \DIFaddbegin \DIFadd{Network), N. (National. E. O. (}\DIFaddend 2025). \emph{\DIFaddbegin {\DIFaddend neonUtilities\DIFaddbegin }\DIFaddend : \DIFaddbegin {\DIFaddend Utilities\DIFaddbegin }
\DIFaddend for \DIFdelbegin \DIFdel{working }\DIFdelend \DIFaddbegin {\DIFadd{Working}} \DIFaddend with \DIFaddbegin {\DIFaddend NEON \DIFdelbegin \DIFdel{data}\DIFdelend \DIFaddbegin \DIFadd{Data}}\DIFaddend }.
\DIFdelbegin %DIFDELCMD < \url{https://doi.org/10.32614/CRAN.package.neonUtilities}
%DIFDELCMD < %%%
\DIFdelend 
...
\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend . (2024a). \emph{Barometric pressure ({DP1}.00004.001)}. National
Ecological Observatory Network (NEON).
\url{https://doi.org/10.48443/RT4V-KZ04}

\bibitem[\citeproctext]{ref-neonSoilCO2}
\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend . (2024b). \emph{Soil {CO2} concentration ({DP1}.00095.001)}.
National Ecological Observatory Network (NEON).
\url{https://doi.org/10.48443/E7GR-6G94}

\bibitem[\citeproctext]{ref-neonSoilProperties}
\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend . (2024c). \emph{Soil physical and chemical properties, {Megapit}
...
\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend . (2024d). \emph{Soil temperature ({DP1}.00041.001)}. National
Ecological Observatory Network (NEON).
\url{https://doi.org/10.48443/Q24X-PW21}

\bibitem[\citeproctext]{ref-neonSoilWater}
\DIFdelbegin \DIFdel{National Ecological Observatory Network (NEON)}\DIFdelend \DIFaddbegin \DIFadd{NEON}\DIFaddend . (2024e). \emph{Soil water content and water salinity
...
\DIFaddbegin \bibitem[\citeproctext]{ref-pedersenHMRFluxEstimation2024}
\DIFadd{Pedersen, A. R. (2024). }\emph{{\DIFadd{HMR}}\DIFadd{: }{\DIFadd{Flux Estimation}} \DIFadd{with }{\DIFadd{Static
Chamber Data}}}\DIFadd{.
}

\DIFaddend \bibitem[\citeproctext]{ref-phillipsValueSoilRespiration2017}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-rheaultGoFluxUserfriendlyWay2024}
\DIFadd{Rheault, K., Christiansen, J. R., \& Larsen, K. S. (2024). }{\DIFadd{goFlux}}\DIFadd{: }{\DIFadd{A}}
\DIFadd{user-friendly way to calculate }{\DIFadd{GHG}} \DIFadd{fluxes yourself, regardless of user
experience. }\emph{\DIFadd{Journal of Open Source Software}}\DIFadd{, }\emph{9}(96)\DIFadd{, 6393.
}\url{https://doi.org/10.21105/joss.06393}

\DIFaddend \bibitem[\citeproctext]{ref-sallamMeasurementGasDiffusion1984}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-wilsonFluxfinderPackageReproducible2024}
\DIFadd{Wilson, S. J., Bond-Lamberty, B., Noyce, G., Bittencourt Peixoto, R., \&
Megonigal, J. P. (2024). Fluxfinder: }{\DIFadd{An R Package}} \DIFadd{for }{\DIFadd{Reproducible
Calculation}} \DIFadd{and }{\DIFadd{Initial Processing}} \DIFadd{of }{\DIFadd{Greenhouse Gas Fluxes From
Static Chamber Measurements}}\DIFadd{. }\emph{\DIFadd{Journal of Geophysical Research:
Biogeosciences}}\DIFadd{, }\emph{129}(11)\DIFadd{, e2024JG008208.
}\url{https://doi.org/10.1029/2024JG008208}

\DIFaddend \bibitem[\citeproctext]{ref-yanMoistureFunctionSoil2018}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-zhaoFluxCalRPackageCalculating2019}
\DIFadd{Zhao, J. (2019). }{\DIFadd{FluxCalR}}\DIFadd{: A }{\DIFadd{R}} \DIFadd{package for calculating }{\DIFadd{CO2}} \DIFadd{and
}{\DIFadd{CH4}} \DIFadd{fluxes from static chambers. }\emph{\DIFadd{Journal of Open Source
Software}}\DIFadd{, }\emph{4}(43)\DIFadd{, 1751. }\url{https://doi.org/10.21105/joss.01751}

\DIFaddend \bibitem[\citeproctext]{ref-zobitzNeonSoilFluxComputeSoil2024}
...
\DIFdelbegin %DIFDELCMD < \url{https://doi.org/10.32614/CRAN.package.neonSoilFlux}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin 

\bibitem[\citeproctext]{ref-zobitzSupportingCodeData2025}
\DIFadd{Zobitz, J., \& Zimmerman, N. (2025). }\emph{\DIFadd{Supporting }{\DIFadd{Code}} \DIFadd{and }{\DIFadd{Data}}
\DIFadd{for }{\DIFadd{neonSoilFlux}}\DIFadd{: }{\DIFadd{An R Package}} \DIFadd{for }{\DIFadd{Continuous Sensor-Based
Estimation}} \DIFadd{of }{\DIFadd{Soil CO2 Fluxes}}}\DIFadd{. Zenodo.
