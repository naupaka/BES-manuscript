...
%DIF DEL BES-manuscript-oldtmp-94961.tex   Sun Nov 16 13:56:12 2025
%DIF ADD BES-manuscript.tex                Sun Nov 16 13:52:02 2025
%DIF 2a2
...
\hypersetup{
%DIF 181-182d205
%DIF <   pdftitle={neonSoilFlux: An R Package for Continuous Sensor-Based Estimation of Soil CO2 Fluxes},
%DIF <   pdfauthor={, , , , , , , , , , , and },
%DIF -------
  colorlinks=true,
  linkcolor={blue},
...
%DIF 190-191c212
%DIF < \title{\texttt{neonSoilFlux}: An R Package for Continuous Sensor-Based
%DIF < Estimation of Soil CO\textsubscript{2} Fluxes}
%DIF -------
 %DIF > 
%DIF -------
\author{\DIFdelbegin \DIFdel{John Zobitz\textsuperscript{1} }%DIFDELCMD < \and %%%
\DIFdel{Edward
Ayres\textsuperscript{2} }%DIFDELCMD < \and %%%
\DIFdel{Zoey Werbin\textsuperscript{3} }%DIFDELCMD < \and %%%
\DIFdel{Ridwan
Abdi\textsuperscript{1} }%DIFDELCMD < \and %%%
\DIFdel{Natalie
Ashburner-Wright\textsuperscript{4} }%DIFDELCMD < \and %%%
\DIFdel{Lillian
Brown\textsuperscript{4} }%DIFDELCMD < \and %%%
\DIFdel{Ryan
Frink-Sobierajski\textsuperscript{4} }%DIFDELCMD < \and %%%
\DIFdel{Lajntxiag
Lee\textsuperscript{1} }%DIFDELCMD < \and %%%
\DIFdel{Dijonë
Mehmeti\textsuperscript{1} }%DIFDELCMD < \and %%%
\DIFdel{Christina
Tran\textsuperscript{4} }%DIFDELCMD < \and %%%
\DIFdel{Ly Xiong\textsuperscript{1} }%DIFDELCMD < \and %%%
\DIFdel{Naupaka
Zimmerman\textsuperscript{4,5}}\DIFdelend }
\date{}
%DIF DELETED TITLE COMMANDS FOR MARKUP
\title{\DIFdelbegin \DIFdel{\texttt{neonSoilFlux}: An R Package for Continuous Sensor-Based
Estimation of Soil CO\textsubscript{2} Fluxes}\DIFdelend }%DIFAUXCMD
...
\DIFdelbegin \DIFdel{\textsuperscript{1} Augsburg University, 2211 Riverside Avenue,
Minneapolis, MN 55454}%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{\textsuperscript{2} National Ecological Observatory Network, Battelle,
1685 38th Street, Suite 100, Boulder, CO 80301}%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{\textsuperscript{3} Boston University, 5 Cummington Street, Boston, MA
02215}%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{\textsuperscript{4} University of San Francisco, 2130 Fulton Street, San
Francisco, CA 94117}%DIFDELCMD < \\
%DIFDELCMD < %%%
...
%DIFDELCMD < %%%
\addcontentsline{toc}{section}{\DIFdel{Acknowledgments}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{JZ acknowledges Kathleen O'Rourke for code development. NZ thanks
...
Statements}}%DIFAUXCMD
%DIFDELCMD < \label{conflict-of-interest-statements}
%DIFDELCMD < %%%
\addcontentsline{toc}{section}{\DIFdel{Conflict of Interest Statements}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{None of the authors have a financial, personal, or professional conflict
...
%DIFDELCMD < %%%
\addcontentsline{toc}{section}{\DIFdel{Author Contributions}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Conceptualization: JZ, NZ; Methodology: EA, JZ, NZ; Software: JZ, NZ,
...
%DIFDELCMD < %%%
\section*{\DIFdel{Data Availability}}%DIFAUXCMD
%DIFDELCMD < \label{data-availability}
%DIFDELCMD < %%%
\addcontentsline{toc}{section}{\DIFdel{Data Availability}}
%DIFAUXCMD
%DIFDELCMD < 
...
%DIFDELCMD < %%%
\DIFdelend \section{Abstract}\label{abstract}
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{figures/r2-plot.png}
...
fell roughly between the two diffusion estimation methods\DIFdelbegin \DIFdel{; however this was less the case in the two driest sites, SJER and }\DIFdelend \DIFaddbegin \DIFadd{. At UNDE,
WOOD, WREF, and SJER, the median field estimate of diffusivity was lower
than both of the other methods. At the driest site, }\DIFaddend SRER
